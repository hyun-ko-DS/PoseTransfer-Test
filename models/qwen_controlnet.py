"""
Qwen ControlNet 모델 클래스
"""

from pathlib import Path
from PIL import Image

# TODO: Qwen ControlNet 구현 필요
class QwenControlnet:
    ...
    def generate(self, input_image, pose_image, output_path, prompt=None):
        ...
        # TODO: Qwen ControlNet API 호출 구현
        raise NotImplementedError("QwenControlnet.generate() 메서드가 아직 구현되지 않았습니다.")
